...
BUILTIN_FUNCTIONS = {
    ...
    'LEFT': {'params': 2, 'param_types': ['STRING', 'INTEGER'], 'return_type': 'STRING'},
    'RIGHT': {'params': 2, 'param_types': ['STRING', 'INTEGER'], 'return_type': 'STRING'},
    'MID': {'params': 3, 'param_types': ['STRING', 'INTEGER', 'INTEGER'], 'return_type': 'STRING'},
...
ERROR_MESSAGES = {
    ...
    'wrong_param_count': "Function '{name}' expects {expected} parameters, but got {actual}",
...
# Help text
HELP_TEXT = """Commands:
  run [filename]  - Analyze pseudocode in specified file (default: examples/basic_example.txt)
