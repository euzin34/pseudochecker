...
class Declaration(ASTNode):
    def __init__(
        self, identifier, dtype, is_array=False, array_bounds=None, is_constant=False
    ):
        self.identifier = identifier
        self.dtype = dtype
        self.is_array = is_array
        self.array_bounds = (
            array_bounds  # List of (lower, upper) tuples for each dimension
        )
...
class Literal(ASTNode):
    def __init__(self, value, literal_type=None):
        self.value = value
        self.literal_type = (
            literal_type  # 'INTEGER', 'REAL', 'STRING', 'CHAR', 'BOOLEAN'
        )
...
class Parser:
    def __init__(self, tokens: List[Token]) -> None:
        ...
        self.current_token: Token = (
            self.tokens[0] if self.tokens else Token(TokenType.EOF, None, 0, 0)
        )
    ...
    def eat(self, token_type: TokenType) -> None:
        if self.current_token.type == token_type:
            ...
            raise SyntaxError(
                f"Expected {token_type.name}, but found {self.current_token.type.name}",
    ...
    def statement(self) -> Any:
        ...
        # File Operations
            ...
            raise SyntaxError(
                ...
                self.current_token.column,
                (
                    "Expected a statement keyword like DECLARE, IF, FOR, WHILE, "
                    "OUTPUT, INPUT, TYPE, or file operation"
                ),
            )
    ...
    def declaration(self):
        ...
        return Declaration(
            identifier, dtype, is_array, array_bounds if is_array else None
        )
    ...
    def assignment_or_call(self):
        ...
        if self.current_token.type == TokenType.LBRACKET:
            ...
            if self.current_token.type == TokenType.ASSIGN:
                ...
                raise SyntaxError(
                    "Expected assignment operator '<-' after array index",
                    self.current_token.line,
                    self.current_token.column,
    ...
    def for_loop(self):
        ...
        if self.current_token.type == TokenType.IDENTIFIER:
            ...
            if next_var != variable:
                raise SyntaxError(
                    (
                        f"NEXT variable '{next_var}' does not match FOR variable '"
                        f"{variable}'"
                    ),
                    self.current_token.line,
                    self.current_token.column,
    ...
    def file_open(self):
        ...
        if self.current_token.type in (
            ...
            raise SyntaxError(
                f"Expected file mode (READ, WRITE, APPEND, or RANDOM), "
