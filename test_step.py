...
code = """Advanced CIE 9618 Pseudocode Examples
Demonstrating arrays, procedures, functions, and advanced features
...
Complex conditional
IF isValid AND x > 0 THEN
OUTPUT \"Valid and positive\"
ENDIF
...
Boolean expressions
isValid <- x > 5 AND y < 10
isValid <- NOT isValid OR x = 0
...
print("Testing FOR loop with STEP:")
print("Pseudocode:")
print(code)
print("\nGenerated Python:")
